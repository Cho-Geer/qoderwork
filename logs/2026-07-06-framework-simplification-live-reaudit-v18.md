...
- `plans/01-phase0-baseline-freeze.md` — 更新 live metric 与 `.trash-db` 归档状态。
- `plans/02-phase1-skill-first.md` — 标记 `preflight-lite/FULL.md` v3.0.0 已轻量化，剩余 stale 文档/回归。
- `plans/03-phase2-native-agent-dag.md`、`plans/04-phase3-enforcement-slimming.md`、`plans/06-phase5-legacy-retirement.md` — 将 native Task 状态统一为 build smoke PASS、完整矩阵 pending。
- `plans/05-phase4-minimal-state.md` — 更新 DB size、state 目录单主 DB与 WAL/SHM 附件口径。
