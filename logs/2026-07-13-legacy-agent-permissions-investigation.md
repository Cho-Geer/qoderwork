...
- `plans/opencode-framework-simplification-roadmap/00-overview.md` / `01-phase0` / `03-phase2` / `04-phase3` / `06-phase5` - 同步 plan 映射 bug、router.ts:235/agent_domain_map 遗留项、A2 核查修正、V5.10 验证项
