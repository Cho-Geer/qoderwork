...
- N2: 1 file with "WSL-only" framing
...
| `.agents/skills/serve-api/reference.md` | 30 | 桶1 ONLY |
| `.agents/skills/opencode-framework-dev/SKILL.md` | 16 | 桶1 + 桶3 (prose) |
| `.agents/skills/isolated-serve-test/SKILL.md` | 15 | 桶1 |
| `.agents/skills/debug-environment-toolkit/SKILL.md` | 12 | 桶2 + N3 fix |
...
| Exact path | Hits | Primary bucket |
|---|---|---|
| `.agents/skills/debug-environment-toolkit/reference.md` | 9 | 桶2 |
| `.agents/skills/doc-code-sync/SKILL.md` | 8 | 桶2 |
| `.agents/skills/skill-diagnosis-optimization/SKILL.md` | 7 | 桶1 + 桶3 |
| `.agents/skills/logs-governance/SKILL.md` | 7 | 桶1 ONLY |
...
| `.agents/skills/guided-code-editing/SKILL.md` | 3 | 桶2 |
| `.agents/skills/plan-audit-archiver/provenance-rules.md` | 2 | 桶3 |
| `.agents/skills/guided-code-editing/reference.md` | 2 | 桶2 |
...
```bash
cd C:\Users\USER\ZCodeProject\qoderwork\.worktrees\check-plan
# Data-driven: discover every file that contains the literal wsl -d + /home/zhaoge target.
for f in $(grep -rl 'wsl -d Ubuntu-24.04' .agents/skills/); do
